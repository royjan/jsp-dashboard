    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground max-w-2xl mt-1">
          ציון ההתאמה (0–100) = מדד ״מלאי מת״ 50% + מחיר 30% + כמות במלאי 20%.
          מדד המלאי-המת שוקל בעיקר את <b>השנה הנוכחית</b>: 70% לפי מכירות 2026 · 20% לפי 2025 · 10% שנות מלאי — פריט שנמכר השנה איננו מת. מחיר גבוה וכמות גדולה במלאי מעלים את הציון. מסונן: קטן/בינוני, מחיר ≥ ₪1,000, יש מלאי.
        </p>
      </div>
