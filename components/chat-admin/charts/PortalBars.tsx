...
import { AXIS_PROPS, BAR_RADIUS, BAR_MAX, ACTIVE_BAR } from '@/components/charts/kit'
    ...
    <div className="space-y-3">
      <ResponsiveContainer width="100%" height={height}>
        <BarChart data={sorted} layout="vertical" margin={{ left: 8, right: 16 }}>
          ...
          />
          <Bar activeBar={ACTIVE_BAR} dataKey="count" radius={BAR_RADIUS.horizontal} maxBarSize={BAR_MAX}>
