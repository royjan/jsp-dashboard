...
>(({ className, style, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'text-left align-middle font-medium text-gray-700 dark:text-gray-300',
      '[&:has([role=checkbox])]:pr-0',
      className,
    )}
    style={{ height: '56px', padding: '12px 20px', ...style }}
    {...props}
  />
))
...
>(({ className, style, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'align-middle text-gray-900 dark:text-gray-100',
      '[&:has([role=checkbox])]:pr-0',
      className,
    )}
    style={{ padding: '14px 20px', ...style }}
    {...props}
  />
))
