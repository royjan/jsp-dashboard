          ...
          <div className="flex gap-2">
            ...
            {filters.vinPattern && filters.vinPattern.length === 17 && !filters.vinPattern.includes('?') && !filters.vinPattern.includes('[') && !filters.vinPattern.includes('(') && (
              <button
                ...
                className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
